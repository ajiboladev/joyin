...
import { collection, getDocs, doc, getDoc, deleteDoc, updateDoc, increment, runTransaction } from "https://www.gstatic.com/firebasejs/12.6.0/firebase-firestore.js";
...
window.unfollowUser = async function(userId, button, event) {
  ...
  try {
    ...
    await runTransaction(db, async (transaction) => {
      ...
      // Delete follower/following docs
    ...
    if (item) {
      ...
      setTimeout(() => {
        ...
        const newCount = Math.max(0, parseInt(totalCountEl.textContent) - 1);
